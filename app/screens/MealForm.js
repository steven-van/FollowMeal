...
const MealForm = ({ navigation }) => {
    ...
    return (
        ...
        <FormContainer>
            ...
            <Input placeholder={"Nom du repas"} onChangeText={setName} value={name}/>
            </InputContainer>
        ...
        <SubButton additionnalStyle={{ marginBottom: 15 }}
            handlePress={() => {
        ...
        <Button
            handlePress={() => handleSubmit({name, restaurant, category, price, ingredient})}
        >
            {"Ajouter"}
        </Button>
